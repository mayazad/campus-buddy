...
unset($__errorArgs, $__bag); ?>
            ...
            <!-- Guest Login -->
            <form method="GET" action="<?php echo e(route('guest.login')); ?>" class="form">
            ...
            <p class="signup">
                ...
                <a class="link link--strong" href="<?php echo e(url('signup')); ?>">Sign Up</a>
            </p>
        </section>
    </main>
</body>

</html><?php /**PATH /Users/mayazad/CampusBuddy/resources/views/login/index.blade.php ENDPATH**/ ?>